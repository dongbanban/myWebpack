...
//  * @LastEditTime: 2021-06-25 15:33:54
...
// function Geti18n() {
//   const handleClick = () => {
//     const data = [['编码', '中文', '英文', '印尼', '缅甸', '泰语']]
//     Object.keys(zh.default).map(code => {
//       return data.push([code, zh.default[code], en.default[code], id.default[code], my.default[code], th.default[code]])
//     })
